	...
	AS
	(
		SELECT CAST('19900101' AS DATETIME) AS [num]
		UNION ALL
	...
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'p@ssword') FROM @password ORDER BY [id] ASC;
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'passw0rd') FROM @password ORDER BY [id] ASC;
	...
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'Friday') FROM @password ORDER BY [id] ASC;
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'foobar') FROM @password ORDER BY [id] ASC;
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'Foobar') FROM @password ORDER BY [id] ASC;
	INSERT INTO @password([password]) SELECT TOP(@top) REPLACE([password], 'password', 'FooBar') FROM @password ORDER BY [id] ASC;
